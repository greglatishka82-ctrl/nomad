                    ...
                    children: [
                      Expanded(
                        child: _QuickActionCard(
                          ...
                          onTap: () => context.push('/booking/new?type=training'),
                        ),
                      ),
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return async.when(
      ...
      data: (pkgs) {
        ...
        final total = package.sessionsCount;
        final remaining = package.remainingSessions;
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Text(
                          '${booking.instructor?.rating ?? 4.9} • Инструктор',
                          style: const TextStyle(
                            fontSize: 12,
                            color: AppColors.onSurfaceVariant,
                          ),
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Container(height: 16, width: 120, color: AppColors.surfaceContainerHigh),
                    const SizedBox(height: 4),
                    Container(height: 12, width: 80, color: AppColors.surfaceContainerHigh),
                  ],
                ),
              ),
            ],
