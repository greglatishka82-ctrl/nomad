          ...
          children: [
            ...
            _InfoSection(
              ...
              children: [
                const _InfoText(
                  text:
                      'NOMAD Driving Academy — ведущая автошкола с государственной лицензией. '
            ...
            _InfoSection(
              ...
              children: [
                const _StatRow(label: 'Лицензия', value: 'Государственная'),
                const _StatRow(label: 'Процент сдачи', value: '98%'),
                const _StatRow(label: 'Опыт инструкторов', value: 'от 5 лет'),
                const _StatRow(label: 'Рейтинг', value: '4.9 из 5.0'),
              ],
            ),
            const SizedBox(height: 24),
